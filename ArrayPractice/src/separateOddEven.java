...
/*
 * This program sorts the array in such a way that all the even numbers
 * comes first in the array then comes the odd number
 */
...
public class separateOddEven {
    ...
    public static int [] separate_odd_even(int arr[])
    {
